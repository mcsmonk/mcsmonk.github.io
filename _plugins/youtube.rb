...
module Jekyll
  class Youtube < Liquid::Tag
    ...
    def render(context)
      ...
      source += "<figure>"
      source += "<iframe width=\"640\" height=\"480\" src=\"https://www.youtube.com/embed/#{@url}\" frameborder=\"0\" allow=\"accelerometer; encrypted-media; gyroscope; picture-in-picture\" allowfullscreen></iframe>"
      source += "</figure>"
      source += "</div>"
      source
    end
