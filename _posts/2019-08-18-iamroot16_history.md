...
last_modified_at: 2020-02-04T17:50:00-15:00
...
>      - early_init_dt_scan (drivers/of/fdt.c) 완료    
>        - early_init_dt_scan_memory (drivers/of/fdt.c) 완료  
>          - early_init_dt_add_memory_arch (drivers/of/fdt.c) 완료  
>            - memblock_add (mm/memblock.c) 완료  
>              - memblock_add_range (mm/memblock.c) 완료  
>                - memblock_double_array (mm/memblock.c) 완료  
>                  - memblock_find_in_range (mm/memblock.c) 완료  
>                    - memblock_find_in_range_node (mm/memblock.c) 완료  
>                      - __memblock_find_range_bottom_up (mm/memblock.c) 완료  
>                        - __next_mem_range (mm/memblock.c) 완료  
>                      - __memblock_find_range_top_down (mm/memblock.c) 완료  
>                  - memblock_free (mm/memblock.c) 완료  
>                    - memblock_remove_range (mm/memblock.c) 완료  
>                      - memblock_isolate_range (mm/memblock.c) 완료  
>                        - memblock_insert_region (mm/memblock.c) 완료  
>                      - memblock_remove_region (mm/memblock.c) 완료  
>                - memblock_merge_regions (mm/memblock.c) 완료  
>          - early_init_dt_mark_hotplug_memory_arch (drivers/of/fdt.c) 완료  
>            - memblock_mark_hotplug (drivers/of/fdt.c) 완료  
>              - memblock_setclr_flag (mm/memblock.c) 완료  
...
>      - early_init_dt_scan (drivers/of/fdt.c) 진행 중  
>        - early_init_dt_scan_nodes (drivers/of/fdt.c) 진행 중  
>        - early_init_dt_scan_chosen (drivers/of/fdt.c) 완료  
>        - early_init_dt_scan_root (drivers/of/fdt.c) 완료  
>        - early_init_dt_scan_memory (drivers/of/fdt.c) 진행 중  
>          - early_init_dt_add_memory_arch (drivers/of/fdt.c) 진행 중  
...
>  - setup_arch (arch/arm64/kernel/setup.c) 진행 중  
>    - setup_machine_fdt (arch/arm64/mm/mmu.c) 진행 중  
>      - fixmap_remap_fdt (arch/arm64/mm/mmu.c) 완료    
>        - memblock_reserve (mm/memblock.c) 완료  
>          - memblock_add_range (mm/memblock.c) 완료  
>      - early_init_dt_scan (drivers/of/fdt.c) 진행 중  
>          - early_init_dt_scan_nodes (drivers/of/fdt.c) 진행 중  
>              - of_scan_flat_dt (drivers/of/fdt.c) 진행 중  
>              - early_init_dt_scan_chosen (drivers/of/fdt.c) 진행 중  
>                  - early_init_dt_check_for_initrd (drivers/of/fdt.c) 진행 중  
>                      - (생략)...  
...
>  - setup_arch (arch/arm64/kernel/setup.c) 진행 중  
>    - early_fixmap_init (arch/arm64/mm/mmu.c) 완료  
>    - early_ioremap_init (arch/arm64/mm/ioremap.c) 완료  
>    - setup_machine_fdt (arch/arm64/mm/mmu.c) 진행 중  
>      - fixmap_remap_fdt (arch/arm64/mm/mmu.c) 진행 중  
>        - __fixmap_remap_fdt (arch/arm64/mm/mmu.c) 진행 중  
>          - create_mapping_noalloc (arch/arm64/mm/mmu.c) 진행 중  
>            - __create_pgd_mapping (arch/arm64/mm/mmu.c) 진행 중  
...
> 요약  
> start_kernel (init/main.c) - boot_cpu_init (init/main.c) 내부  
>  - page_address_init (mm/highmem.c) 완료  
>  - setup_arch (arch/arm64/kernel/setup.c) 진행 중  
>    - early_fixmap_init (arch/arm64/mm/mmu.c) 진행 중  
